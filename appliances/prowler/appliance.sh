...
AUTH_URL=http://localhost:${ONEAPP_PROWLER_UI_PORT}
API_BASE_URL=http://prowler-api:${ONEAPP_PROWLER_API_PORT}/api/v1
NEXT_PUBLIC_API_BASE_URL=http://localhost:${ONEAPP_PROWLER_API_PORT}/api/v1
...
DJANGO_ALLOWED_HOSTS=localhost,127.0.0.1,prowler-api,$(get_local_ip)
