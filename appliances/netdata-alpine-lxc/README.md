...
Netdata Monitoring running on Alpine Linux in an LXC container.

This appliance provides a lightweight, production-ready deployment of netdata optimized for edge and IoT environments.
...
4. Access services:
   - Netdata Monitoring: http://<container-ip>:19999
