...
ONE_SERVICE_PARAMS=(
    ...
    'GNB_SLICES_SST'          'configure' 'gNB SST of the supported S-NSSAI'                                                                      'O|number'
    'GNB_TAC'                 'configure' 'gNB Tracking Area Code'                                                                                'O|number'
    ...
    'UE_CONFIGURED_NSSAI_SST' 'configure' 'UE SST of the NSSAI configured by HPLMN'                                                               'O|number'
    'UE_DEFAULT_NSSAI_SD'     'configure' 'UE SD of the default Configured NSSAI. Minimum length of 6.'                                           'O|text'
    'UE_DEFAULT_NSSAI_SST'    'configure' 'UE SST of the default Configured NSSAI'                                                                'O|number'
    ...
    'UE_SESSION_SST'          'configure' 'UE SST of the initial PDU session to be stablished'                                                    'O|number'
