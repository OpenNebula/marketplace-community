...
update_envfiles()
{
    ...
    declare -A var_map=(
        ...
        ["SITES_BRANCH"]="ONEAPP_TNLCM_SITES_BRANCH"
        ["SITES_DEPLOYMENT_SITE"]="ONEAPP_TNLCM_DEPLOYMENT_SITE"
        ["SITES_DEPLOYMENT_SITE_TOKEN"]="ONEAPP_TNLCM_DEPLOYMENT_SITE_TOKEN"
    )
